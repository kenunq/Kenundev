...
class TalentsModel(models.Model):
    ...
    creator = models.ForeignKey(
        User, on_delete=models.CASCADE, null=True, verbose_name="Создатель талантов"
    )
    talent_class = models.CharField(max_length=128, verbose_name="Класс", default="")
    talent_spec = models.CharField(
        max_length=128, verbose_name="Путь до изображения спецификации", default=""
    )
